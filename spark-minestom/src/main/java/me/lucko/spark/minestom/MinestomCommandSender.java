...
public class MinestomCommandSender extends AbstractCommandSender<CommandSender> {
    public MinestomCommandSender(CommandSender source) {
        super(source);
    }
    ...
    public String getName() {
        ...
        } else if (super.delegate instanceof ConsoleSender) {
            return "Console";
        } else {
    ...
    public void sendMessage(Component message) {
        super.delegate.sendMessage(MinestomComponentSerializer.get().serialize(message));
    }
